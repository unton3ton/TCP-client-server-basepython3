...
with open('ReinierZonneveld&KikiSolvej-BerlinAmsterdam(SloooooowRemixxx).mp3', 'rb') as f:
    # get the size of the image
    image_size = os.path.getsize('ReinierZonneveld&KikiSolvej-BerlinAmsterdam(SloooooowRemixxx).mp3')
